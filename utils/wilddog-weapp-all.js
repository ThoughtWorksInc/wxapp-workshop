!function (t, e) {
    ...
    return function (t) {
        ...
        var o = r(5), s = r(6), i = r(18), a = r(19), c = r(20), u = r(21)("engine.io-client:websocket"), h = r(24).WebSocket;
        ...
        e.protocol = 3;
        var v = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, b = h(v), w = {
            type: "error",
            data: "parser error"
        }, k = r(16);
        ...
        (function (t) {
            ...
            !function (s) {
                ...
                var d = "object" == o(e) && e, y = "object" == o(t) && t && t.exports == d && t, g = "object" == ("undefined" == typeof global ? "undefined" : o(global)) && global;
        ...
        var s = global.BlobBuilder || global.WebKitBlobBuilder || global.MSBlobBuilder || global.MozBlobBuilder, i = function () {
            try {
                var t = new Blob(["hi"]);
                return 2 === t.size
            } catch (e) {
        ...
        var d = /^([a-z0-9.+-]+:)/i, y = /:[0-9]*$/, g = ["<", ">", '"', "`", " ", "\r", "\n", "\t"], m = ["{", "}", "|", "\\", "^", "`"].concat(g), v = ["'"].concat(m), b = ["%", "/", "?", ";", "#"].concat(v), w = ["/", "?", "#"], k = 255, S = /^[a-z0-9A-Z_-]{0,63}$/, x = /^([a-z0-9A-Z_-]{0,63})(.*)$/, A = {
            javascript: !0,
            "javascript:": !0
        }, C = {javascript: !0, "javascript:": !0}, B = {
            http: !0,
            https: !0,
            ftp: !0,
            gopher: !0,
        ...
        n.prototype.parse = function (t, e, r) {
            ...
            var a = r.pathname && "/" === r.pathname.charAt(0), u = t.host || t.pathname && "/" === t.pathname.charAt(0), l = u || a || r.host && t.pathname, f = l, d = r.pathname && r.pathname.split("/") || [], o = t.pathname && t.pathname.split("/") || [], y = r.protocol && !B[r.protocol];
        ...
        (function (t) {
            ...
            !function (s) {
                ...
                var v = "object" == o(e) && e && !e.nodeType && e, b = "object" == o(t) && t && !t.nodeType && t, w = "object" == ("undefined" == typeof global ? "undefined" : o(global)) && global;
                w.global !== w && w.window !== w && w.self !== w || (s = w);
                var k, S, x = 2147483647, A = 36, C = 1, B = 26, O = 38, P = 700, j = 72, E = 128, U = "-", L = /^xn--/, T = /[^\x20-\x7E]/, I = /[\x2E\u3002\uFF0E\uFF61]/g, q = {
...
(function (ns) {
    ...
    ns.wrapper = function (goog, wd) {
            ...
            a.prototype.bindAsArray = function (a, e) {
                ...
                for (var g = [], k = {
                    child_added: function (a, e) {
                        ...
                        var e = b(g, a.key()), e = g.splice(e, 1);
        ...
        $a.prototype.update = function (a, b) {
            if (null != a) {
                ...
                for (var c = b - this.hb, d = 0, e = this.Vd, f = this.$b; d < b;) {
                    if (0 == f)for (; d <= c;)ab(this, a, d), d += this.hb;
                    if (q(a))for (; d < b;) {
        ...
        function Lb(a) {
            for (var b = "", c = 0; c < arguments.length; c++)var d = arguments[c], e = da(d), b = "array" == e || "object" == e && "number" == typeof d.length ? b + Lb.apply(null, arguments[c]) : "object" === typeof arguments[c] ? b + u(arguments[c]) : b + arguments[c], b = b + " ";
            return b
        }
        ...
        A.prototype.Qf = function (a, b) {
            var c = !0, d;
            for (d in bc)if (bc.hasOwnProperty(d) && bc[d] === a) {
                c = !1;
                break
            }
        ...
        var bc = {gb: "authStateChanged", Ie: "authTokenExpired"};
        A.prototype.qb = bc;
        ...
        function sc(a, b, c) {
            if (a.Z == rc) {
                ...
                a:{
                    ...
                    if (e instanceof qc)Dc(e, yc(f || aa, g || null, a)), d = !0; else {
                        var k;
                        if (e)try {
                            k = !!e.$goog_Thenable
                        } catch (m) {
        ...
        function Cc(a, b, c, d) {
            if (c == vc && b.gc && !b.Uc)for (; a && a.ed; a = a.Ba)a.ed = !1;
            if (b.u)b.u.Ba = null, Hc(b, c, d); else try {
        ...
        E.prototype.Og = function (a, b) {
            ...
            var c = new C, d = this;
            Qc(this.__authManager, "unlink", {idToken: this.Ga(), deleteProvider: [a]}, D(c, function (c, f) {
        ...
        E.prototype.cg = function (a, b) {
            ...
            var c = new C;
            Sc(this.__authManager, a, {authType: "link", idToken: this.Ga()}, D(c, b));
            return c.o
        };
        ...
        E.prototype.dg = function (a, b) {
            ...
            Mc("wilddog.auth().signInWithPopup", a);
            var c = new C;
            Tc(this.__authManager, a, {authType: "link", idToken: this.Ga()}, D(c, b));
            return c.o
        };
        ...
        E.prototype.Pg = function (a, b) {
            ...
            var c = new C;
            Nc(this.__authManager, {email: a, idToken: this.Ga()}, D(c, b));
            return c.o
        };
        ...
        E.prototype.Rg = function (a, b) {
            ...
            var c = new C;
            Nc(this.__authManager, {phoneNumber: a, idToken: this.Ga()}, D(c, b));
            return c.o
        };
        ...
        E.prototype.Ug = function (a, b) {
            ...
            var c = new C;
            Uc(this.__authManager, {phoneNumber: this.ge(), smsCode: a}, D(c, b));
            return c.o
        };
        ...
        E.prototype.Qg = function (a, b) {
            ...
            var c = new C;
            Nc(this.__authManager, {password: a, idToken: this.Ga()}, D(c, b));
            return c.o
        };
        ...
        E.prototype.sg = function (a) {
            ...
            var b = new C;
            Vc(this.__authManager, {idToken: this.Ga(), requestType: "VERIFY_EMAIL"}, D(b, a));
            return b.o
        };
        ...
        E.prototype.vg = function (a) {
            ...
            var b = new C;
            Wc(this.__authManager, {phoneNumber: this.ge(), type: "PHONE_VERIFY"}, D(b, a));
            return b.o
        };
        ...
        function ad(a) {
            var b = {}, c = {}, d = {}, e = "";
            try {
                var f = a.split("."), g = Jb(f[0]) || "", k = Jb(f[1]) || "", b = Ca(g), c = Ca(k), e = f[2], d = c.d || {};
                delete c.d
            } catch (l) {
                console.warn("error", l)
            }
            return {ah: b, Xd: c, data: d, eh: e}
        }
        ...
        cd.prototype.set = function (a, b) {
            if (!b)if (this.Ld.length)b = this.Ld[0]; else throw Error("wd.auth.SessionManager : No storage options available!");
            b.set(this.se, a)
        };
        cd.prototype.get = function () {
            var a = eb(this.Ld, r(this.Yf, this)), a = db(a, function (a) {
                return null !== a
            });
            kb(a, function (a, c) {
        ...
        function id(a) {
            ...
            if (b) {
                var c = v.get("redirect_client_options"), d = Xa(["XHR", "JSONP"]);
        ...
        function Qc(a, b, c, d) {
            var e = {idToken: c.idToken}, f = c.photoURL || a.Qa.currentUser.photoURL, g = c.displayName || a.Qa.currentUser.displayName;
            switch (b) {
                case "unlink":
        ...
        function Id(a, b, c) {
            ...
            if (ha(b)) {
                var d = !1, e = !1;
                qa(b, function (b, g) {
                    if (".value" === b)d = !0; else if (".priority" !== b && ".sv" !== b && (e = !0, !Ed(b)))throw Error(a + " contains an invalid key (" + b + ") " + Bd(c) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
                    c.push(b);
                    Id(a, g, c);
                    c.pop()
                });
        ...
        function Jd(a, b) {
            ...
            for (c = 0; c < b.length; c++) {
                d = b[c];
                for (var e = d.slice(), f = 0; f < e.length; f++)if ((".priority" !== e[f] || f !== e.length - 1) && !Ed(e[f]))throw Error(a + "contains an invalid key (" + e[f] + ") in path " + d.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
            }
            b.sort(H.Yg);
            e = null;
            for (c = 0; c < b.length; c++) {
        ...
        function M(a) {
            ...
            this.Ff = function (a) {
                ...
                return {qc: b[1], gh: b[2], Wg: b[0], yd: "", Xe: "wilddog" !== b[2]}
        ...
        M.prototype.tg = function (a, b) {
            ...
            var c = new C;
            Vc(this.ca, {requestType: "RESET_PASSWORD", email: a}, D(c, b));
            return c.o
        };
        ...
        M.prototype.ug = function (a, b) {
            ...
            var c = new C;
            Wc(this.ca, {type: "PASSWORD_RESET", phoneNumber: a}, D(c, b));
            return c.o
        };
        ...
        M.prototype.Lf = function (a, b, c, d) {
            ...
            var e = new C;
            sd(this.ca, {phoneNumber: a, password: c, smsCode: b}, D(e, d));
            return e.o
        };
        ...
        M.prototype.Cg = function (a, b) {
            ...
            var c = new C;
            Oc(this.ca, {providerId: "custom", token: a}, D(c, b));
            return c.o
        };
        ...
        M.prototype.Dg = function (a, b, c) {
            ...
            var d = new C;
            Oc(this.ca, {providerId: "password", password: b, email: a}, D(d, c));
            return d.o
        };
        ...
        M.prototype.Eg = function (a, b, c) {
            ...
            var d = new C;
            Oc(this.ca, {providerId: "password", password: b, phoneNumber: a}, D(d, c));
            return d.o
        };
        ...
        M.prototype.Mf = function (a, b, c) {
            ...
            var d = new C;
            pd(this.ca, {email: a, password: b}, D(d, c));
            return d.o
        };
        ...
        M.prototype.Nf = function (a, b, c) {
            ...
            var d = new C;
            pd(this.ca, {phoneNumber: a, password: b}, D(d, c));
            return d.o
        };
        ...
        M.prototype.Fg = function (a, b) {
            ...
            Mc("wilddog.auth().signInWithPopup", a);
            var c = new C;
            Sc(this.ca, a, {authType: "login"}, D(c, b));
            return c.o
        };
        ...
        M.prototype.Gg = function (a, b) {
            ...
            var c = new C;
            Tc(this.ca, a, {authType: "login"}, D(c, b));
            return c.o
        };
        ...
        h.hash = function () {
            if (null === this.yb) {
                ...
                var b = typeof this.I, a = a + (b + ":"), a = "number" === b ? a + Wb(this.I) : a + this.I;
                this.yb = Kb(a)
            }
            return this.yb
        };
        ...
        h.uc = function (a) {
            ...
            var b = typeof a.I, c = typeof this.I, d = cb(oe, b), e = cb(oe, c);
        ...
        function te(a, b, c, d, e) {
            this.Ed = e || null;
            this.le = d;
            for (this.Ta = []; !a.f();)if (e = b ? c(a.key, b) : 1, d && (e *= -1), 0 > e)a = this.le ? a.left : a.right; else if (0 === e) {
                this.Ta.push(a);
                break
        ...
        function S(a) {
            ...
            var b = a.Ta.pop(), c;
            c = a.Ed ? a.Ed(b.key, b.value) : {key: b.key, value: b.value};
            if (a.le)for (b = b.left; !b.f();)a.Ta.push(b), b = b.right; else for (b = b.right; !b.f();)a.Ta.push(b), b = b.left;
            return c
        }
        ...
        function ue(a) {
            ...
            b = a.Ta;
            b = b[b.length - 1];
            return a.Ed ? a.Ed(b.key, b.value) : {key: b.key, value: b.value}
        }
        ...
        function O(a, b) {
            ...
            if (g) {
                var m = je(f, Xd(R));
                return new T(l, O(c), new ge({".priority": m}, {".priority": R}))
            }
        ...
        function je(a, b, c, d) {
            function e(b, d) {
                ...
                var g = parseInt(f / 2, 10) + b, f = e(b, g), B = e(g + 1, d), g = a[g], k = c ? c(g) : g;
            ...
            var f = function (b) {
                ...
                for (var f = null, g = null, P = a.length, B = 0; B < b.count; ++B) {
                    var ca = Me(b), Fd = Math.pow(2, b.count - (B + 1));
        ...
        var Zd = new Ne, Je = new N("[MIN_NAME]", Q), ee = new N("[MAX_NAME]", Zd);
        ...
        function af(a, b) {
            if (a.F.za)b(a.F.za); else {
                var c = Xa(["XHR", "JSONP", "NodeHttp", "WxHttp"]), c = db(c, function (a) {
                    return "function" === typeof a.isAvailable && a.isAvailable()
                });
        ...
        h.Mc = function (a) {
            ...
            this.re({serverTimeOffset: a - (new Date).getTime()});
            a = Ua.get("UUID");
        ...
        h.He = function (a, b) {
            this.Ka = a;
            var c = ad(a), d = c.data, c = c.Xd && c.Xd.exp;
        ...
        function Tf(a, b, c) {
            if (null != a.value && c(a.value))return {path: L, value: a.value};
            if (b.f())return null;
            var d = J(b);
            a = a.children.get(d);
            return null !== a ? (b = Tf(a, K(b), c), null != b ? {path: (new H(d)).u(b.path), value: b.value} : null) : null
        }
        ...
        wg.prototype.fb = function (a, b, c, d) {
            var e = new xg, f;
            if (b.type === Kf)b.source.ce ? c = yg(this, a, b.path, b.Na, c, d, e) : (x(b.source.Re, "Unknown source."), f = b.source.Ce, c = zg(this, a, b.path, b.Na, c, d, f, e)); else if (b.type === If)b.source.ce ? c = Ag(this, a, b.path, b.children, c, d, e) : (x(b.source.Re, "Unknown source."), f = b.source.Ce, c = Bg(this, a, b.path, b.children, c, d, f, e)); else if (b.type === Ff)if (b.ve)if (f = b.path, null != c.mc(f))c = a; else {
                b = new ug(c, a, d);
                d = a.J.j();
                if (f.f() || ".priority" === J(f))a.C().M ? b = c.ya(jg(a)) : (b = a.C().j(), x(b instanceof T, "serverChildren would be complete if leaf node"), b = c.sc(b)), b = this.L.xa(d, b, e); else {
                    f = J(f);
                    var g = c.Za(f, a.C());
            ...
            } else c = Cg(this, a, b.path, c, d, e); else if (b.type === Mf)d = b.path, b = a.C(), f = b.j(), g = b.M || d.f(), c = Dg(this, new gg(a.J, new eg(f, g, b.Sb)), d, c, tg, e); else throw Ib("Unknown operation type: " + b.type);
            e = tb(e.kb);
            d = c;
            b = d.J;
        ...
        function Dg(a, b, c, d, e, f) {
            ...
            var k;
            if (c.f())x(b.C().M, "If change path is empty, we must have complete server data"), b.C().Sb ? (e = jg(b), d = d.sc(e instanceof T ? e : Q)) : d = d.ya(jg(b)), f = a.L.xa(b.J.j(), d, f); else {
                var l = J(c);
                if (".priority" == l)x(1 == vd(c), "Can't have a priority with additional path components"), f = g.j(), k = b.C().j(), d = d.Vc(c, f, k), f = null != d ? a.L.ga(f, d) : g.j(); else {
                    var m = K(c);
        ...
        h.Bd = function (a) {
            ...
            if (d) {
                if (e)this.V = Zg(this.Ea, $g, L), this.Cc = 0 < this.Ea.length ? this.Ea[this.Ea.length - 1].Sd : -1; else if (c.Na)this.V = this.V.Bd(c.path); else {
                    var k = this;
        ...
        function Zg(a, b, c) {
            for (var d = Qg, e = 0; e < a.length; ++e) {
                ...
                if (b(f)) {
                    var g = f.path;
                    if (f.Na)c.contains(g) ? (g = I(c, g), d = Rg(d, g, f.Na)) : g.contains(c) && (g = I(g, c), d = Rg(d, L, f.Na.sa(g))); else if (f.children)if (c.contains(g))g = I(c, g), d = Sg(d, g, f.children); else {
                        if (g.contains(c))if (g = I(g, c), g.f())d = Sg(d, L, f.children); else if (f = t(f.children, J(g)))f = f.sa(K(g)), d = Rg(d, L, f)
        ...
        function ch(a, b, c, d, e) {
            ...
            p(g) || (g = !0);
            f.Ea.push({path: b, Na: c, Sd: d, visible: g});
            g && (f.V = Rg(f.V, b, c));
            f.Cc = d;
        ...
        function eh(a, b, c, d) {
            ...
            e.Ea.push({path: b, children: c, Sd: d, visible: !0});
            e.V = Sg(e.V, b, c);
            e.Cc = d;
            c = Rf(c);
        ...
        bh.prototype.nb = function (a, b, c) {
            ...
            if (e && ("default" === ff(a) || null != Og(e, a))) {
                ...
                if (!g && 0 < e.length && !c)if (b)this.Dc.Kd(a, null); else {
                    var P = this;
                    ta(e, function (a) {
                        ff(a);
                        var b = P.jc[mh(a)];
        ...
        function oh(a, b, c) {
            ...
            d = a.wa.subtree(d);
            if (e)x(null == Mg(d.value), "If we're adding a query, it shouldn't be shadowed"); else for (e = Wf(d, function (a, b, c) {
        ...
        function uh(a, b, c, d, e) {
            ...
            c.children.na(function (c, f) {
                var k = d ? d.P(c) : null, l = e.u(c), B = b.Nc(c);
        ...
        wh.prototype.get = function () {
            var a = this.Jf.get(), b = Ab(a);
            if (this.nd)for (var c in this.nd)b[c] -= this.nd[c];
            this.nd = a;
            return b
        };
        function xh(a, b) {
        ...
        function Jh(a) {
            if (null !== a.Ba) {
                var b = a.Ba, c = a.rd, d = a.f(), e = pa(b.H.children, c);
        ...
        h.ob = function (a, b, c, d) {
            this.m("set", {path: a.toString(), value: b, bh: c});
            var e = Wh(this);
            b = O(b, c);
            var e = Eh(b, e), f = this.sd++, e = ch(this.S, a, e, f, !0);
            Nh(this.ha, e);
            var g = this;
        ...
        h.update = function (a, b, c) {
            this.m("update", {path: a.toString(), value: b});
            var d = !0, e = Wh(this), f = {};
            w(b, function (a, b) {
                d = !1;
                var c = O(a);
            ...
            if (d)Ra("update() called with empty data.  Don't do anything."), Zh(c, "ok"); else {
                var g = this.sd++, k = eh(this.S, a, f, g);
                Nh(this.ha, k);
                var l = this;
        ...
        function fi(a, b, c, d, e) {
            ...
            g.Ab("value", f);
            c = {
                path: b, update: c, N: d, status: null, order: Hb(), Ge: e, rf: 0, Pd: function () {
                    g.fc("value", f)
                }, Td: null, Fa: null, Zc: null, $c: null, ad: null
            };
            d = a.S.ya(b, void 0) || Q;
            c.Zc = d;
            d = c.update(d.O());
        ...
        function ji(a, b, c) {
            for (var d = eb(c, function (a) {
                ...
                g.status = 2;
                g.rf++;
                var k = I(b, g.path), d = d.K(k, g.$c)
            }
            var d = d.O(!0), l = a.la;
            a.ka.put(b.toString(), d, function (d) {
                a.m("transaction put response", {path: b.toString(), status: d});
                var e = [];
                if ("ok" === d) {
                    d = [];
                    ...
                    if ("datastale" === d)for (f = 0; f < c.length; f++)c[f].status = 4 === c[f].status ? 5 : 1; else for (y("transaction at " + b.toString() + " failed: " + d), f = 0; f < c.length; f++)c[f].status = 5, c[f].Td = d;
                    Xh(a, b)
                }
            }, e)
        }
        ...
        function li(a, b, c) {
            if (0 !== b.length) {
                for (var d = [], e = [], f = eb(b, function (a) {
                    ...
                    var k = b[g], l = I(c, k.path), m = !1, P;
                    x(null !== l, "rerunTransactionsUnderNode_: relativePath should not be null.");
                    if (5 === k.status)m = !0, P = k.Td, e = e.concat(fh(a.S, k.Fa, !0)); else if (1 === k.status)if (25 <= k.rf)m = !0, P = "maxretry", e = e.concat(fh(a.S, k.Fa, !0)); else {
        ...
        function ni(a, b) {
            var c = b.Ha();
            if (null !== c) {
                for (var d = [], e = [], f = -1, g = 0; g < c.length; g++)4 !== c[g].status && (2 === c[g].status ? (x(f === g - 1, "All SENT items should be at beginning of queue."), f = g, c[g].status = 4, c[g].Td = "set") : (x(1 === c[g].status, "Unexpected transaction status in abort"), c[g].Pd(), e = e.concat(fh(a.S, c[g].Fa, !0)), c[g].N && d.push(r(c[g].N, null, Error("set"), !1, null))));
        ...
        function xi(a, b, c, d, e, f) {
            ...
            x(b.zb() == a.ea, "");
            var l = new N(c, d), m = a.Gb ? He(b, a.g) : Ie(b, a.g), P = a.va.matches(l);
            if (b.Ma(c)) {
                var B = b.P(c), m = e.de(a.g, m, a.Gb);
        ...
        function ri(a, b) {
            ...
            if (e) {
                var f = e.type;
                if ("child_added" == c && "child_removed" == f)a.kb[d] = new V("child_changed", b.Oa, d, e.Oa); else if ("child_removed" == c && "child_added" == f)delete a.kb[d]; else if ("child_removed" == c && "child_changed" == f)a.kb[d] = new V("child_removed", e.pe, d); else if ("child_changed" == c &&
                    "child_added" == f)a.kb[d] = new V("child_added", b.Oa, d); else if ("child_changed" == c && "child_changed" == f)a.kb[d] = new V("child_changed", b.Oa, d, e.pe); else throw Ib("Illegal combination of changes: " + b + " occurred after " + e);
            } else a.kb[d] = b
        };
        function yi() {
        ...
        Z.prototype.ef = function (a, b) {
            ...
            Md("Query.once", a, !1);
            G("Query.once", 2, b, !0);
            var d = Fi("Query.once", arguments[2], arguments[3]), e = this, f = !0, g = new C;
            Kc(g.o);
        ...
        function Fi(a, b, c) {
            ...
            if (b && c)d.cancel = b, G(a, 3, d.cancel, !0), d.context = c, ud(a, 4, d.context); else if (b)if ("object" === typeof b && null !== b)d.context = b; else if ("function" === typeof b)d.cancel = b; else throw Error(td(a, 3, !0) + " must either be a cancel callback or a context object.");
            return d
        };
        function Gi(a, b) {
            this.committed = a;
        ...
        (function (a) {
            ...
            [{id: "password", name: "Wilddog", rb: "phoneOrEmail", Ya: "password"}, {id: "password", name: "Email", rb: "email", Ya: "password"}, {
                id: "qq",
                name: "QQ",
                rb: "accessToken",
                Ya: "openId"
            }, {id: "weibo", name: "Weibo", rb: "accessToken", Ya: "openId"}, {id: "weixin", name: "Weixin", rb: "accessToken", Ya: "openId"}, {
                id: "weixinmp",
                name: "Weixinmp",
                rb: "accessToken",
                Ya: "openId"
        ...
        if ("WEB" == CLIENT_TYPE)"object" == typeof module && module.exports && (module.exports = Sd), "function" == typeof define && define.amd && define("wilddog", [], function () {
            return Sd
        }), window ? window.wilddog = Sd : WorkerGlobalScope && self && (self.wilddog = Sd); else if ("NODE" == CLIENT_TYPE || "WX" == CLIENT_TYPE || "RN" == CLIENT_TYPE)module.exports = Sd;
    };
